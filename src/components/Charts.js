...
<div>
  <div className='mx-auto flex lg:my-8 max-w-7xl sm:px-6 lg:px-0 flex-wrap'>
    <h2 className='my-1 font-bold lg:text-2xl font-san sm:text-lg'>Masters</h2>
    <div className=" items-center w-full max-w-lg mx-5 lg:max-w-xs">
                  ...
                  <div className='justify-items-end'>
                        <button onClick={() => setOpen(true)} className="flex rounded-full bg-gray-800 text-sm text-white focus:outline-none focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                    <div className="px-4 sm:px-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-lg font-medium text-gray-900">New Company</Dialog.Title>
