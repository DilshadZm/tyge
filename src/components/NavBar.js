...
export default function Layout({ children }) {
  ...
  return (
    <div className="p-0">
      <Disclosure as="nav" className="bg-gradient-to-r from-red-500  to-violet-900">
      {({ open }) => (
        <>
    ...
    <Menu as="div" className="relative inline-block text-left">
        ...
        <Menu.Button className="inline-flex w-full justify-center ">
          <SiRos className="-mr-1 ml-2 h-8 w-8 text-white" aria-hidden="true" />
        </Menu.Button>
      </div>
      ...
      <MdFactCheck className="-mr-1 ml-5 h-11 w-11 text-yellow-400"/>
                <div className="hidden lg:ml-1 lg:block">
                  ...
                  <div className="flex space-x-4 max-w-xs">
                    ...
                    <a href="#" className="rounded-md px-3 py-2 text-s font-medium text-white">
                    Supplier Invoice <br/>Management System
                    </a>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="absolute inset-y-0 my-auto h-8 w-12 border-r border-transparent stroke-gray-100 px-3.5 peer-focus:border-lime-300 peer-focus:stroke-lime-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              ...
              <div className="hidden lg:ml-4 lg:block">
                ...
                <button
                  ...
                  >
                    ...
                    <AiOutlineExclamationCircle className="h-6 w-6" aria-hidden="true" />
                  </button>
                  <button
                    type="button"
                    className="flex-shrink-0 rounded-full  p-1 text-gray-100 mx-2 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
